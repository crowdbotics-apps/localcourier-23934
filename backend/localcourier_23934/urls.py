"""localcourier_23934 URL Configuration
...
admin.site.site_header = "Localcourier"
admin.site.site_title = "Localcourier Admin Portal"
admin.site.index_title = "Localcourier Admin"

# swagger
api_info = openapi.Info(
    title="Localcourier API",
    default_version="v1",
    description="API documentation for Localcourier App",
)
